...
return [
    'web_powermail' => [
        ...
        'target' => [
            '_default' => ModuleController::class . '::listAction',
        ],
        'controllerActions' => [
    ...
    'powermail_overview_be' => [
        ...
        'controllerActions' => [
            ModuleController::class => 'overviewBe',
        ],
    ],
    'powermail_reporting_form' => [
        ...
        'controllerActions' => [
            ModuleController::class => 'reportingFormBe',
        ],
    ],
    'powermail_reporting_marketing' => [
        ...
        'controllerActions' => [
            ModuleController::class => 'reportingMarketingBe',
        ],
    ],
    'powermail_check_be' => [
        'parent' => 'web_powermail',
        ...
        'controllerActions' => [
            ModuleController::class => 'checkBe,' .
                'fixUploadFolder, fixWrongLocalizedForms, fixFilledMarkersInLocalizedFields, ' .
                'fixWrongLocalizedPages, fixFilledMarkersInLocalizedPages',
        ],
    ],
