...
class FormController extends AbstractController
{
     ...
     * @throws Exception
     */
    #[ExtbaseAnnotation\Validate(['validator' => UploadValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => InputValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => PasswordValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => CaptchaValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => SpamShieldValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => UniqueValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => ForeignValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => CustomValidator::class, 'param' => 'mail'])]
    public function confirmationAction(?Mail $mail = null): ResponseInterface
    {
        if ($this->isMailParamEmpty()) {
            return (new ForwardResponse('form'))->withoutArguments();
        }

        if ($this->formParamsDoNotMatch()) {
            return (new ForwardResponse('form'))->withoutArguments();
        }
    ...
    #[ExtbaseAnnotation\Validate(['validator' => ForeignValidator::class, 'param' => 'mail'])]
    #[ExtbaseAnnotation\Validate(['validator' => CustomValidator::class, 'param' => 'mail'])]
    public function createAction(?Mail $mail = null, string $hash = ''): ResponseInterface
    {
        if ($this->isMailParamEmpty()) {
            return (new ForwardResponse('form'))->withoutArguments();
        }
    ...
    public function optinConfirmAction(int $mail, string $hash): ResponseInterface
    {
        ...
        /** @noinspection PhpUnhandledExceptionInspection */
        if ($mail instanceof Mail && HashUtility::isHashValid($hash, $mail)) {
            ...
            if ($this->formParamsDoNotMatchForOptinConfirm($mail)) {
                return (new ForwardResponse('form'))->withoutArguments();
            }
    ...
    public function disclaimerAction(int $mail, string $hash): ResponseInterface
    {
        ...
        if ($mail instanceof Mail && HashUtility::isHashValid($hash, $mail, 'disclaimer')) {
            $event = GeneralUtility::makeInstance(
     ...
     */
    protected function formParamsDoNotMatchForOptinConfirm(?Mail $mail = null): bool
    {
