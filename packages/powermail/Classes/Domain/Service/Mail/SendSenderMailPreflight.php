...
class SendSenderMailPreflight
{
    ...
    public function __construct(protected array $settings, protected array $conf, Request $request, MailerInterface $mailer)
    {
        $this->sendMailService = GeneralUtility::makeInstance(SendMailService::class, $request, $mailer);
